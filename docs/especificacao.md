# Cronograma-de-Gravacoes — especificacao do projeto
...
*Gerado com Vieira CLI (`vieira common` ou scaffold `front` / `full` / `extension`). Epics do repositorio Vieira CLI no board usam a regra `especificacao-cards.mdc` — fluxo separado.*
